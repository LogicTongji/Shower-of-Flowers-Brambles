...
table.insert(WarMapAdapter.Leaders, {
	id = 2,
	leaderId = "administrative_probe",
	leaderType = "administrative",
	role = "administrative",
	textKey = "WARMAP_ADMINISTRATIVE_PROBE",
	portrait = "GFX_warmap_leader_li_zongren",
	nameKey = "WARMAP_ADMINISTRATIVE_PROBE",
	descriptionKey = "WARMAP_ADMINISTRATIVE_PROBE_DESC"
})
table.insert(WarMapAdapter.Leaders, {
	id = 3,
	leaderId = "military_probe",
	leaderType = "military",
	role = "military",
	textKey = "WARMAP_MILITARY_PROBE",
	portrait = "GFX_warmap_leader_li_zongren",
	nameKey = "WARMAP_MILITARY_PROBE",
	descriptionKey = "WARMAP_MILITARY_PROBE_DESC"
})
...
assert(not GuiActionBridge.Dispatch("assign_war_map_leader", {
	itemId = 1
}))
...
assert(GuiActionBridge.Dispatch("assign_war_map_leader", {
	itemId = 1
}))
assert(GuiActionBridge.Dispatch("assign_war_map_leader", {
	itemId = 2
