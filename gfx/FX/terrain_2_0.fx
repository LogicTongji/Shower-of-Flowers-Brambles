...
float4 PixelShader_Map2_0_General_Low( VS_MAP_OUTPUT v ) : COLOR
{
	...
	float4 OutColor;
	OutColor.r = OverlayColor.r < 0.5 ? (2 * OverlayColor.r * Color.r) : (1 - 4 * (1 - OverlayColor.r) * (1 - Color.r));
	OutColor.g = OverlayColor.r < 0.5 ? (2 * OverlayColor.g * Color.g) : (1 - 4 * (1 - OverlayColor.g) * (1 - Color.g));
	OutColor.b = OverlayColor.b < 0.5 ? (2 * OverlayColor.b * Color.b) : (1 - 4 * (1 - OverlayColor.b) * (1 - Color.b));
