...
economy = {
	...
	RESOURCE_TO_IC_COST			= 0.30,	 -- For calc IC from damage done to resources (for strat warfare overview)
...
military = {
	...
	SHORE_BOMBARDMENT_MOD = -0.05,
	SHORE_BOMBARDMENT_CAP = -0.40,
	...
	AMPHIBIOUS_INVADE_SPEED_BASE = 0.2, -- every hour movement progress on amphibious invasion
	AMPHIBIOUS_INVADE_MOVEMENT_COST = 64.0, -- total progress cost of movement while amphibious invading
