...
local _RESEARCH_SOPHISTICATED_ = 8
local _RESEARCH_SECRET_ = 9
local _RESEARCH_UNKNOWN_ = 10
...
function Process_Tech(pYear, pMaxYear, ResearchSlotsAllowed, ResearchSlotsNeeded)
	...
	laPrimeTechAreas[_RESEARCH_NAVAL_] = {Folder = {"smallship_folder",
										   "capitalship_folder",
										   "submarine_and_anti_submarine_folder"},
								ResearchWeight = 0, 
								CurrentSlots = 0, 
								ResearchSlots = 0, 
								RegularTech = {}, 
	...
	laPrimeTechAreas[_RESEARCH_INDUSTRIAL_] = {Folder = {"industry_folder"},
								...
								ListIgnore = {},
								ListPrefer = {}}
	laPrimeTechAreas[_RESEARCH_SOPHISTICATED_] = {Folder = {"sophisticated_equipment_folder"},
								ResearchWeight = 0, 
								CurrentSlots = 0, 
								ResearchSlots = 0, 
								RegularTech = {}, 
								PreferTech = {},
								ListName = "SophisticatedEquipmentTechs",
								ListIgnore = {},
								ListPrefer = {}}
	...
	if not(lbIndustry) or not(loInfra.lbInfra) then
		...
		laPrimeTechAreas[_RESEARCH_SOPHISTICATED_].ResearchWeight = 0.0
	...
	for k, v in pairs(laPrimeTechAreas) do
		...
		elseif v.ListName == "NavalTechs" then
			if not(lbNavalBase) and TechnologyData.PortsTotal > 0 then
				v.ListPrefer = {"torpedoboat_technology"}
			end
